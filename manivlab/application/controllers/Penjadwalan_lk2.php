...
class Penjadwalan_lk2 extends CI_Controller
{
...
function index($year = null, $month = null, $day = null, $idlabkom = 2  ){
	...
	function detail_event(){		
		...
		if ($this->form_validation->run() == FALSE){
			...
			$data = $this->penjadwalan->getEvent($this->input->post('year', true), $this->input->post('mon', true), $this->input->post('day', true), 2);
			if($data == null){
...
function detail($year = null, $month = null, $day = null, $idlabkom = 2  ){
	...
	function _setting(){
		return array(
			'start_day' 		=> 'monday',
			'show_next_prev' 	=> true,
			'next_prev_url' 	=> base_url('penjadwalan_lk2/index'),
			'month_type'   		=> 'long',
            'day_type'     		=> 'short',
