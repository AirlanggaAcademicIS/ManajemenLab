...
class History extends CI_Controller
{
 ...
 /*   $this->load->model('model');
	...
	$aa = array ('table2'=> $tabel2); */
		...
		$data['table']=$this->model2->Getpppk();
		$data['table2']=$this->model2->GetIden();
	...
	function getLaporanItemByTgl(){
		...
		$this->load->model('model2');
		$result['item_pppk'] = $this->model2->GetpppkbyTanggal($start_date,$end_date,$kategori);
		$result['iden'] = $this->model2->GetIdenbyTanggal($start_date,$end_date,$kategori);
