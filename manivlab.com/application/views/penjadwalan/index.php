<body>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/css/calendarstyle.css"/>
					...
					if(isset($events)){
						...
						foreach($events as $e){
						 if($i % 2 == 0){
                                ...
                                <h4>'.$e['time'].'-'.$e['time1'].'<img src="'.base_url().'assets/images/calendar/delete.png" class="delete" alt="" title="delete this event" day="'.$day.'" val="'.$e['id'].'" /></h4>
				...
				success: function( data ) {
					...
					if(data.status){
						...
						$.each(data.data, function(index, value) {
						    if(i % 2 == 0){
								html = html+'<div class="info1"><h4>'+value.time+'-'+value.time1+'<img src="<?php echo base_url();?>assets/images/calendar/delete.png" class="delete" alt="" title="delete this event" day="'+day+'" val="'+value.id+'" /></h4><p>Kegiatan: '+value.event+'</p><p>PJMA: '+value.pjma+'</p></div>';
							}else{
								html = html+'<div class="info2"><h4>'+value.time+'-'+value.time1+'<img src="<?php echo base_url();?>assets/images/calendar/delete.png" class="delete" alt="" title="delete this event" day="'+day+'" val="'+value.id+'" /></h4><p>Kegiatan: '+value.event+'</p><p>PJMA: '+value.pjma+'</p></div>';
							} 
							i++;
						});
					}else{
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <ul class="list-unstyled">
                        <li><a href="<?php echo base_url();?>gb">Home</a></li>
