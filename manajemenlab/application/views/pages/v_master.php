...
<div class="tabbable tabs-left">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tabBarang" data-toggle="tab"><strong>XXX</strong></a></li>
        <li><a href="#tabPelanggan" data-toggle="tab"><strong>YYY</strong></a></li>
        <li><a href="#tabPegawai" data-toggle="tab"><strong>ZZZ</strong></a></li>
        <li><a href="#tabContact" data-toggle="tab"><strong>TTT</strong></a></li>
    </ul>
