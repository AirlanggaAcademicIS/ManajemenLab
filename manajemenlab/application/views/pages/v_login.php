...
<div class="container">
    ...
    Level Admin= Username : admin , Password : admin </div>

    <br>
    <form class="form-signin" action="<?= site_url('login/cek_login')?>" method="post">
        <hr>
        <h4 class="form-signin-heading text-center">MANIVLAB</h4>
    ...
    <hr>
    <div class="footer">
        <p>&copy; Created By : <a href="MANIVLAB.COM" target="_blank"><strong>manivlab.com</strong></a></p>
    </div>
</div>
</body>
