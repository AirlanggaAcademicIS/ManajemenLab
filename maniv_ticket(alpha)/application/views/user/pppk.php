...
<html>
	...
	<body class="fixed">
                ...
                <div class="sidebar">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>user/datapppk">
                            <i class="fa fa-eye"></i> <span>Lihat Data PSL</span>
								...
								<form role="form" id="" action="<?php echo base_url(); ?>user/simpanpppk" method="post">
								  ...
								  <div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											<label>labkom</label>
											<select name="labkom" onChange="getobject(this.value)" class="form-control">
                                                <option value="">---Pilih labkom---</option>
                                                <?php foreach ($labkoms as $key): ?>
                                                    <option value="<?php echo $key['labkom'] ?>"><?php echo $key['labkom'] ?></option>
                                                <?php endforeach ?>
                                            </select>
										</div>
										<div class="col-sm-6">
        ...
        function getobject(value){
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('user/getobject');?>",
                data:"key="+value,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#labkom").change(function(){
               /*dropdown post */
               $.ajax({
                url:"<?php echo base_url(); ?>user/getobject",    
                data: {labkom: $(this).val()},
                type: "POST",
                success: function(data){
